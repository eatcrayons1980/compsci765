...
%- display current knowledge about the user in the beginning (maybe try to implement) \\
%- add more characteristics to user model (friends, inventory,...) \\
%- integrate better natural language processing to infer travel facts and make interaction more of a conversation than a QA session \\
%- improve rec based on weather \\
%- extend database of travelfacts \\
%- user interface \\
%- find similarities between stuff \\
%- determine size of location (city, region, country) from place in hierarchy \\
